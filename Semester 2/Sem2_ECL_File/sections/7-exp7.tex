\chapter{Full Wave Rectification}
	...
	\section{Theory}
		...
		\subsection{Full Wave Rectifier}
			...
			\begin{figure}[ht]
				\centering 
				\subfloat[Full Wave Rectification]{\includegraphics[width=0.9\textwidth]{img/exp7/2}
					\label{fig:fwrSinGraph}}
				\vfill
				\subfloat[Half Wave Rectification with Waveform changed by 180$^{\circ}$]{\includegraphics[width=0.9\textwidth,valign=c]{img/exp7/4}
					\label{fig:fwr_hwrBy180}}
				\vfill
				\subfloat[2 different Half Wave Rectifications]{\includegraphics[width=0.9\textwidth,valign=c]{img/exp7/5}
		...
		\subsection{Full Wave Rectifier – Waveforms}
			\begin{figure}[ht]
				\centering 
				\subfloat[Simple $sin x$ wave]{\includegraphics[width=0.45\textwidth, valign=c]{img/exp7/7}
					\label{fig:fwr_sin_waveform}}
				\subfloat[180$^{\circ}$ inverted $sin x$ wave]{\includegraphics[width=0.45\textwidth,valign=c]{img/exp7/8}
					\label{fig:fwr_sin_180_waveform}}
				\vfill
				\subfloat[Rectified $\lvert sin x \rvert$ wave]{\includegraphics[width=0.9\textwidth,valign=c]{img/exp7/9}
		...
		\subsection{Full Wave Rectifier – Center Tapped Transformer}
			...
			\begin{figure}[ht]
				\centering 
				\subfloat[Center-Tapped Transformer]{\includegraphics[width=0.4\textwidth]{img/exp7/10}
					\label{fig:fwr_centerTappedTransformer}}
				\hfill
				\subfloat[Symbol of Center-Tapped Transformer]{\includegraphics[width=0.4\textwidth,valign=c]{img/exp7/11}
		...
		\subsection{Bridge Rectifier}
			...
			\begin{figure}[ht]
				\centering 
				\subfloat[Center-Tapped Transformer]{\includegraphics[width=0.45\textwidth]{img/exp7/15}
					\label{fig:fwr_bridgeRectifier_positiveCycle}}
				\hfill
				\subfloat[Symbol of Center-Tapped Transformer]{\includegraphics[width=0.45\textwidth,valign=c]{img/exp7/16}
