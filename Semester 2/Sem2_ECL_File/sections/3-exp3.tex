\chapter{Familiarisation with Inductor}
	...
	\section{Theory}
		\subsection{Function of an Inductor}
			\begin{figure}[ht]
				\centering 
				\subfloat[A valve]{\includegraphics[width=0.3\textwidth,valign=c]{img/exp3/1}
					\label{fig:funcInduc:1}}	
				\hfill
				\subfloat[A resistor]{\includegraphics[width=0.3\textwidth,valign=c]{img/exp3/2}
					\label{fig:funcInduc:2}}
				\hfill
				\subfloat[An Inductor]{\includegraphics[width=0.3\textwidth,valign=c]{img/exp3/3}
		...
		\subsection{Structure of an Inductor}
			\begin{figure}[ht]
				\centering 
				\subfloat[Structure of different types of Inductors]{\includegraphics[width=0.45\textwidth,valign=c]{img/exp3/4}
					\label{fig:strInduc}}	
				\hfill
				\subfloat[Internal view of an inductor]{\includegraphics[width=0.45\textwidth,valign=c]{img/exp3/5}
